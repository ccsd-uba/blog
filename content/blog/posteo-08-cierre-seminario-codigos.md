+++
title = "Teoría de Códigos, Low-Degree Testing y PIOPs: un seminario en la intersección entre la universidad pública y el sector privado"
description = "Finalizó la primera edición del seminario del CCSD sobre Teoría de Códigos, Low-Degree Testing y PIOPs, coorganizado con LambdaClass, con más de 35 participantes y sedes rotativas entre FCEN, FIUBA y LambdaClass."
date = 2026-07-03
[taxonomies]
tags = ["criptografía", "seminario", "teoría de códigos", "ZK proofs"]
+++
